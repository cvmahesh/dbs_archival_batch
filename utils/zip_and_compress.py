...
def tar_and_gzip(source_file, filename, destination_dir):
    ...
    try:
        ...
        logger.info(f"Tar file '{tar_file}' created successfully.")
    ...
    try:
        ...
        logger.info(f"GZIP file '{gz_file}' created successfully.")
    except Exception as e:
        logger.error(f"Error compressing tar file: {e}")
        return

    # Step 3: Remove the intermediate .tar file
    try:
        os.remove(tar_file)
        logger.info(f"Intermediate tar file '{tar_file}' removed.")
    except Exception as e:
        logger.error(f"Error removing tar file: {e}")

    # Step 4: Remove the source file
    try:
        os.remove(source_file)
        logger.info(f"Source file '{source_file}' removed successfully.")
    except Exception as e:
        logger.error(f"Error removing source file: {e}")
...
def uncompress_tar_gz(src_tar_gz_file, destination_dir):
    ...
    if not os.path.exists(src_tar_gz_file):
        logger.error(f"Error: The file '{src_tar_gz_file}' does not exist.")
        return
    ...
    try:
        ...
        logger.info(f"Files from '{src_tar_gz_file}' extracted successfully to '{destination_dir}'.")
    except Exception as e:
    ...
    try:
        ...
        logger.info(f"Source file '{src_tar_gz_file}' removed successfully.")
    except Exception as e:
        logger.error(f"Error removing source tar.gz file: {e}")
